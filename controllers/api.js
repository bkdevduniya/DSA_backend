...
const sendEmail = async function(email) {
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        user: 'bk.mandawat.06@gmail.com', // Your Gmail address
        pass: 'vimj avti fphy wdnw',  // Application-specific password
      },
    });
...
module.exports={checkLoggedIn,logoutUser,postQuestion,createSheet,markSolved,unsolved,skip,searchHandler,userStats,handleSheetStatusChange,sheetsProvider,provideSheetQuestions,sendPasswordResetLink};
